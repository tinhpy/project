                            ...
                            bcrypt.hash(newUser.password, salt, (err, hash) => {
                                ...
                                newUser
                                    ...
                                    .then(user => {
                                        ...
                                        req.flash(
                                            'success_msg',
                                            'Đăng ký thành công. Một email vừa được gửi đến tài khoản để xác thực. Vui lòng kiểm tra trong 12h'
                                        );
    ...
    resendVerify: (req,res) =>{
        User.findOne({loginName: req.body.loginName})
            .then(user =>{
                ...
                req.flash(
                    'success_msg',
                    'Đã gửi một email xác thực.Vui lòng kiểm tra trong 12h'
                );
                res.redirect('/users/resendVerify');
            })
            .catch(err => { throw err})
    }
};